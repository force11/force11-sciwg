...
- update on RDA Plenary Melbourne (Dan and Morane). Submissions for session proposal Software Source Identification WG and Software Source Code IG. The first session if about use cases, the second about FAIR for software.
