...
- CodeMeta task force
  - Action: Martin to update us next time on task force
...
- Neil's author checklist/guidelines task force
  ...
  - now working to finalize drafts of docs that can be circulated to beta readers, moving towards release at FORCE2019 and publicity in advance
...
- Repository task force
  - [notes from July 11 calls](https://docs.google.com/document/d/1UyV77TSilH6UlJtikw18F8OZXTOdPRlvueKPC-xNGys/edit)
  - identifying and documenting best practices items for a repositories best practices list, including publishing metadata schema used
  - Alice and Caltech applied to Sloan for funding to support a workshop for repositories - dates Nov 13-14, at U Maryland, with topics including 
    - repositories producing and sharing metadata in standard formats like CodeMeta; for example, for ASCL entry https://ascl.net/1907.032 ASCL produces https://ascl.net/1907.032/codemeta.json
  - From Alice: next task force conference call (partially on "legal stuff" that should be published as a best practice) Thursday, August 8, offering two times (as before) to accommodate all time zones.
...
- Next monthly Force11 Software Citation Implementation WG call will be on September 3 at 15:00 Berlin time
