...
- Publicity and Practices:
   - Have resubmitted revised version addressing reviews for F1000 paper
...
- Publishers focus on DOI's - how might we get better support for other PIDs? Trying to make sure that others don't get obliterated.
