...
- Will alternate between these going forward (as suggested by Daina)
  - Neil to update calendar/zoom invitations
...
- IMLS Software Citation workshop
  ...
  - [Hypothesis version of this document, for annotation](https://via.hypothes.is/https://arxiv.org/pdf/1905.08674.pdf) - adding notes about changes that have happened since this was written.
  - Focus groups coming in advance of the meeting to proritize problems and identify known bottlenecks and barriers
    - ACTION for this call: What prompts would make sense for these groups?
