...
* discussion going on in core Python team about how to make Python itself citable: https://mail.python.org/pipermail/python-dev/2018-September/thread.html#155128 - Dan to follow up with Jackie ...
  ...
  * And specifically: @adrn's [CitationPEP](https://github.com/) which is [mentioned at the end of that thread as inspiration for "a more developed proposal"](https://mail.python.org/pipermail/python-dev/2018-September/155297.html).
