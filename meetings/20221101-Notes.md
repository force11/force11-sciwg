...
- ACTION: Daina to draft a proposal for a session at FORCE2022 to present the outcomes of the IMLS workshop, deadline 20 October
  - This wasn't submitted, but we're now seeing if there's any chance to still submit.
...
- FORCE2022 (Dan to check with Daina)
  ...
  - Daina intended to submit a proposal on an update, using the IMLS workshop outcomes as the key part, but this didn't happen, so we're now checking to see if we can still submit (late)
